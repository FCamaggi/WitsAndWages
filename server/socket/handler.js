...
async function revealAnswer(room, code, io) {
    ...
    // Calcular y pagar apuestas ganadoras (o perder fichas de póquer)
    currentRound.bets.forEach(bet => {
        ...
        if (isWinningBet) {
            ...
            // PIERDE: Pierde las fichas de póquer apostadas (si había)
...
function checkWinningBet(bet, result, answers) {
    ...
    // NOTA: El espacio GREEN (2to1-green) NO paga a RED ni BLACK 1to1
